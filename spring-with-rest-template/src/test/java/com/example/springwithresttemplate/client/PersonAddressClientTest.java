...
public class PersonAddressClientTest {
    ...
    public void testGetPersonServerException(){
        ...
        PersonAddressClientException thrown = Assertions.assertThrows(PersonAddressClientException.class,()->{
            Mockito.when(restTemplate.exchange(argumentCaptor.capture(), Mockito.eq(HttpMethod.GET), Mockito.eq(HttpEntity.EMPTY), Mockito.eq(Person.class))).thenThrow(new HttpServerErrorException(HttpStatus.INTERNAL_SERVER_ERROR));
            sut.getPerson(1L);
            Mockito.verify(restTemplate, Mockito.times(1)).exchange(argumentCaptor.capture(), Mockito.any(), Mockito.any(), Mockito.eq(Person.class));
            assertEquals( "http://one-to-one/persons/1",argumentCaptor.getValue());
        });
    ...
    public void testGetServerException(){
        ...
        NotFoundException thrown=Assertions.assertThrows(NotFoundException.class,()->{
            Mockito.when(restTemplate.exchange(argumentCaptor.capture(), Mockito.eq(HttpMethod.GET), Mockito.eq(HttpEntity.EMPTY), Mockito.eq(Person.class))).thenThrow(new HttpServerErrorException(HttpStatus.NOT_FOUND));
            sut.getPerson(1L);
            Mockito.verify(restTemplate, Mockito.times(1)).exchange(argumentCaptor.capture(), Mockito.any(), Mockito.any(), Mockito.eq(Person.class));
        });
        assertEquals( "http://one-to-one/persons/1",argumentCaptor.getValue());
    ...
    public void testGetPersonClientException(){
        ArgumentCaptor<String> argumentCaptor = ArgumentCaptor.forClass(String.class);
        PersonAddressClientException thrown = Assertions.assertThrows(PersonAddressClientException.class,()->{
            Mockito.when(restTemplate.exchange(argumentCaptor.capture(), Mockito.eq(HttpMethod.GET), Mockito.eq(HttpEntity.EMPTY), Mockito.eq(Person.class))).thenThrow(new HttpClientErrorException(HttpStatus.CONFLICT));
            sut.getPerson(1L);
            Mockito.verify(restTemplate, Mockito.times(1)).exchange(argumentCaptor.capture(), Mockito.any(), Mockito.any(), Mockito.eq(Person.class));
        });
        assertEquals( "http://one-to-one/persons/1",argumentCaptor.getValue());
    ...
    public void testGetClientException(){
        ArgumentCaptor<String> argumentCaptor = ArgumentCaptor.forClass(String.class);
        NotFoundException thrown=Assertions.assertThrows(NotFoundException.class,()->{
            Mockito.when(restTemplate.exchange(argumentCaptor.capture(), Mockito.eq(HttpMethod.GET), Mockito.eq(HttpEntity.EMPTY), Mockito.eq(Person.class))).thenThrow(new HttpClientErrorException(HttpStatus.NOT_FOUND,"This is not found"));
            sut.getPerson(1L);
            Mockito.verify(restTemplate, Mockito.times(1)).exchange(argumentCaptor.capture(), Mockito.any(), Mockito.any(), Mockito.eq(Person.class));
        });
        assertEquals( "http://one-to-one/persons/1",argumentCaptor.getValue());
